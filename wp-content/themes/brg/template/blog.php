...
<section class="container else wow fadeInUpBig">
    ...
    <div class="else-content">
        ...
        <?php
          ...
          <a href="<?= strpos($url, '/en') !== false ? '/news-en' : '/news'; ?>" class="else-item">
        ...
        <?php
          ...
          <a href="<?= strpos($url, '/en') !== false ? '/events-en' : '/events'; ?>" class="else-item">
                <div class="else-img-wrapper">
                    <img src="<?=get_field('image', $item->ID); ?>" alt="photo">
                    <span></span>
                </div>
        ...
        <?php
          ...
          <a href="<?= strpos($url, '/en') !== false ? '/adverts-en' : '/adverts'; ?>" class="else-item">
                <div class="else-img-wrapper">
                    <img src="<?=get_field('image', $item->ID); ?>" alt="photo">
                    <span></span>
                </div>
